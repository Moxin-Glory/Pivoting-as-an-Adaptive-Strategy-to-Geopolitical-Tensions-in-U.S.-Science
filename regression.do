...
*======================================================
* Set panel structure for author-year data and create difference-in-differences (DiD) interaction term
...
esttab m1 m2 m3 m4 m5 m6 using "/your path/table 3.html", ///
    replace b(%9.3f) se(%7.3f) scalars(N r2_a) star(* 0.1 ** 0.05 *** 0.001) ///
